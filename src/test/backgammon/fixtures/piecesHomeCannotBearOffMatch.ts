...
let match = {
  ...
  gameState: {
    ...
    points: [
      ...
      { number: 13, pieces: [{id: 20, playerNumber: 2}], selected: false },
      ...
      { number: 19, pieces: [{id: 26, playerNumber: 1}, {id: 27, playerNumber: 1}, {id: 28, playerNumber: 1}], selected: false },
      { number: 20, pieces: [{id: 24, playerNumber: 1}, {id: 25, playerNumber: 1}], selected: false },
      { number: 21, pieces: [], selected: false },
      { number: 22, pieces: [{id: 18, playerNumber: 2}, {id: 19, playerNumber: 2}], selected: false },
