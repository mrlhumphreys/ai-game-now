...
let gameState = {
  ...
  offBoard: {
    pieces: [
      {id: 29, playerNumber: 2},
      {id: 30, playerNumber: 2},
      {id: 16, playerNumber: 2},
      {id: 17, playerNumber: 2},
      {id: 18, playerNumber: 2},
      {id: 19, playerNumber: 2},
      {id: 20, playerNumber: 2},
      {id: 8, playerNumber: 2},
      {id: 9, playerNumber: 2},
      {id: 10, playerNumber: 2},
      {id: 3, playerNumber: 2},
      {id: 4, playerNumber: 2},
      {id: 5, playerNumber: 2},
      {id: 6, playerNumber: 2},
