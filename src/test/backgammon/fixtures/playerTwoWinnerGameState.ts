...
let gameState = {
  ...
  points: [
    ...
    { number: 8, pieces: [], selected: false},
  ...
  off_board: {
    pieces: [
      {id: 29, player_number: 2}, 
      {id: 30, player_number: 2},
      {id: 16, player_number: 2}, 
      {id: 17, player_number: 2}, 
      {id: 18, player_number: 2}, 
      {id: 19, player_number: 2}, 
      {id: 20, player_number: 2},
      {id: 8, player_number: 2}, 
      {id: 9, player_number: 2}, 
      {id: 10, player_number: 2},
      {id: 3, player_number: 2}, 
      {id: 4, player_number: 2}, 
      {id: 5, player_number: 2}, 
      {id: 6, player_number: 2}, 
      {id: 7, player_number: 2}
    ],
    selected: false
  }
};
