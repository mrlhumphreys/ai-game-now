...
let match = {
  ...
  game_state: {
    ...
    points: [
      ...
      { number: 19, pieces: [{id: 1, player_number: 1}], selected: false },
      { number: 20, pieces: [], selected: false },
      { number: 21, pieces: [], selected: false },
      { number: 22, pieces: [{id: 24, player_number: 1}, {id: 25, player_number: 1}], selected: false },
    ...
    off_board: {
      pieces: [
        ...
        {id: 27, player_number: 1}, 
        {id: 28, player_number: 1}
      ],
      selected: false
    }
  },
