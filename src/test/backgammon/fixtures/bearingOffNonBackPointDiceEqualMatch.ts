...
let match = {
  ...
  gameState: {
    ...
    points: [
      ...
      { number: 19, pieces: [{id: 1, playerNumber: 1}], selected: false },
      { number: 20, pieces: [], selected: false },
      { number: 21, pieces: [], selected: false },
      { number: 22, pieces: [{id: 24, playerNumber: 1}, {id: 25, playerNumber: 1}], selected: false },
    ...
    offBoard: {
      pieces: [
        ...
        {id: 27, playerNumber: 1},
        {id: 28, playerNumber: 1}
      ],
      selected: false
    }
  },
