...
let match = {
  ...
  game_state: {
    ...
    bar: {
      pieces: [{id: 29, player_number: 2}],
      selected: true 
    },
    points: [
      { number: 1, pieces: [], selected: false },
      { number: 2, pieces: [{id: 1, player_number: 1}, {id: 2, player_number: 1}], selected: false },
      ...
      { number: 24, pieces: [{id: 30, player_number: 2}], selected: false },
    ],
    off_board: {
      pieces: [],
      selected: false
