...
let match = {
  ...
  game_state: {
    ...
    points: [
      ...
      { number: 3, pieces: [{id: 1, player_number: 1}, {id: 2, player_number: 1}], selected: true },
      ...
      { number: 7, pieces: [{id: 8, player_number: 2}], selected: false },
      { number: 8, pieces: [{id: 9, player_number: 2}, {id: 10, player_number: 2}], selected: false},
      { number: 9, pieces: [{id: 11, player_number: 1}], selected: false },
      { number: 10, pieces: [], selected: false },
      { number: 11, pieces: [], selected: false },
      { number: 12, pieces: [{id: 12, player_number: 1}, {id: 13, player_number: 1}, {id: 14, player_number: 1}, {id: 15, player_number: 1}], selected: false },
