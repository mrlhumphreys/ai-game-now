...
let match = {
  ...
  gameState: {
    ...
    points: [
      ...
      { number: 3, pieces: [{id: 1, playerNumber: 1}, {id: 2, playerNumber: 1}], selected: true },
      ...
      { number: 7, pieces: [{id: 8, playerNumber: 2}], selected: false },
      { number: 8, pieces: [{id: 9, playerNumber: 2}, {id: 10, playerNumber: 2}], selected: false},
      { number: 9, pieces: [{id: 11, playerNumber: 1}], selected: false },
      { number: 10, pieces: [], selected: false },
      { number: 11, pieces: [], selected: false },
      { number: 12, pieces: [{id: 12, playerNumber: 1}, {id: 13, playerNumber: 1}, {id: 14, playerNumber: 1}, {id: 15, playerNumber: 1}], selected: false },
