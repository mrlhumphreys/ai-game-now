...
let match = {
  ...
  game_state: {
    ...
    points: [
      ...
      { number: 13, pieces: [{id: 18, player_number: 2}, {id: 19, player_number: 2}, {id: 20, player_number: 2}], selected: false },
      ...
      { number: 19, pieces: [ {id: 27, player_number: 1}, {id: 28, player_number: 1}], selected: false },
      { number: 20, pieces: [{id: 29, player_number: 2}, {id: 30, player_number: 2}], selected: false },
      { number: 21, pieces: [{id: 16, player_number: 2}, {id: 17, player_number: 2}], selected: false },
    ...
    off_board: {
      pieces: [
        ...
        {id: 24, player_number: 1},
        {id: 25, player_number: 1},
        {id: 26, player_number: 1}
      ],
      selected: false
    }
  },
