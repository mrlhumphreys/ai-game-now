...
let gameState = {
  ...
  points: [
    { number: 1, pieces: [{id: 1, playerNumber: 1}, {id: 2, playerNumber: 1}], selected: true },
    { number: 2, pieces: [], selected: false },
    { number: 3, pieces: [], selected: false },
    { number: 4, pieces: [ {id: 3, playerNumber: 2} ], selected: false },
    { number: 5, pieces: [], selected: false },
    { number: 6, pieces: [{id: 4, playerNumber: 2}, {id: 5, playerNumber: 2}, {id: 6, playerNumber: 2}, {id: 7, playerNumber: 2}], selected: false },
