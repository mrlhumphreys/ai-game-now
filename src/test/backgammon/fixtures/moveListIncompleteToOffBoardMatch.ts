...
let match = {
  ...
  game_state: {
    ...
    points: [
      ...
      { number: 19, pieces: [{id: 26, player_number: 1}, {id: 27, player_number: 1}, {id: 28, player_number: 1}], selected: false },
      { number: 20, pieces: [], selected: false },
      { number: 21, pieces: [], selected: false },
      { number: 22, pieces: [], selected: false },
      { number: 23, pieces: [{id: 24, player_number: 1}], selected: true },
  ...
  winner: null,
  move_list: [{ fromId: 22, toId: 'off_board' }],
  last_action: null,
