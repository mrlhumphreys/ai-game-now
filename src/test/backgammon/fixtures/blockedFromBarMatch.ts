...
let match = {
  ...
  game_state: {
    ...
    bar: {
      pieces: [{id: 1, player_number: 1}, {id: 2, player_number: 1}],
      selected: false
    },
    points: [
      { number: 1, pieces: [], selected: false },
      { number: 2, pieces: [], selected: false },
      { number: 3, pieces: [{id: 3, player_number: 2}, {id: 4, player_number: 2}], selected: false },
      { number: 4, pieces: [{id: 5, player_number: 2}, {id: 6, player_number: 2}], selected: false },
