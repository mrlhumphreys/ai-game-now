...
let gameState = {
  ...
  first_turn: true,
  dice: [
    { id: 0, number: 4, used: false },
    { id: 1, number: 5, used: false }
  ],
  bar: {
  ...
  points: [
    { number: 1, pieces: [ {id: 2, player_number: 1} ], selected: false },
    { number: 2, pieces: [ {id: 3, player_number: 2}, {id: 4, player_number: 2} ], selected: false },
    { number: 3, pieces: [ {id: 5, player_number: 2}, {id: 6, player_number: 2} ], selected: false },
    { number: 4, pieces: [], selected: false },
    { number: 5, pieces: [], selected: false },
    { number: 6, pieces: [ {id: 7, player_number: 2} ], selected: false },
