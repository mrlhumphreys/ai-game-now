...
describe('piecesOwnedByPlayer', () => {
  it('returns pieces owned by the player', () => {
    let bar = { name: 'bar', pieces: [ { id: 1, playerNumber: 1 }, { id: 2, playerNumber: 2 } ], selected: false };
    let playerNumber = 1;
...
describe('hasPiecesOwnedByPlayer', () => {
  ...
  it('must return false if bar has no pieces owned by player', () =>{
    let bar = { name: 'bar', pieces: [ { id: 2, playerNumber: 2 } ], selected: false };
    let playerNumber = 1;
    let result = hasPiecesOwnedByPlayer(bar, playerNumber);
...
describe('deselect', () => {
  it('unmarks bar as selected', () => {
    let bar = { name: 'bar', pieces: [ { id: 1, playerNumber: 1 }, { id: 2, playerNumber: 2 } ], selected: true };
    deselect(bar);
...
describe('pop', () => {
  it('removes and returns the piece owned by the player', () => {
    ...
    expect(bar.pieces).toEqual([{ id: 2, playerNumber: 2 }]);
