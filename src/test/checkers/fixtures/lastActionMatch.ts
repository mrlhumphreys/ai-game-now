...
let match = {
  ...
  game_state: {
    ...
    squares: [
      ...
      { id: 10, x: 4, y: 5, marked: false, piece: { id: 16, king: false, player_number: 2, selected: false } },
      ...
      { id: 18, x: 4, y: 3, marked: false, piece: { id: 17, king: false, player_number: 2, selected: false } },
  ...
  winner: null,
  current_move_from_id: 7,
  current_move_to_ids: [14],
  last_action: { kind: 'move', data: { fromId: 7, toIds: [14, 23] } },
