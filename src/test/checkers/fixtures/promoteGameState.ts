...
let gameState = {
  ...
  squares: [
    ...
    { id: 18, x: 4, y: 3, marked: false, piece: { id: 13, king: false, player_number: 2, selected: false} },
    ...
    { id: 26, x: 4, y: 1, marked: false, piece: { id: 10, king: false, player_number: 1, selected: false} },
