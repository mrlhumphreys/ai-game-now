...
let gameState = {
  player_number: 1,
  squares: [
    { id: 1, x: 6, y: 7, marked: false, piece: { id: 0, king: false, player_number: 1, selected: true} },
    ...
    { id: 11, x: 2, y: 5, marked: false, piece: { id: 10, king: false, player_number: 1, selected: false} },
