...
let gameState = {
  ...
  squares: [
    { id: 1, x: 6, y: 7, marked: false, piece: { id: 0, king: false, playerNumber: 1, selected: true} },
    ...
    { id: 7, x: 3, y: 6, marked: false, piece: { id: 6, king: false, playerNumber: 1, selected: false} },
    { id: 8, x: 1, y: 6, marked: false, piece: { id: 7, king: false, playerNumber: 1, selected: false} },

    { id: 9, x: 6, y: 5, marked: false, piece: { id: 8, king: false, playerNumber: 1, selected: false} },
    { id: 10, x: 4, y: 5, marked: false, piece: { id: 9, king: false, playerNumber: 1, selected: false} },
    { id: 11, x: 2, y: 5, marked: false, piece: { id: 10, king: false, playerNumber: 1, selected: false} },
    { id: 12, x: 0, y: 5, marked: false, piece: { id: 11, king: false, playerNumber: 1, selected: false} },

    { id: 13, x: 7, y: 4, marked: true, piece: null },
    ...
    { id: 21, x: 7, y: 2, marked: false, piece: { id: 12, king: false, playerNumber: 2, selected: false} },
    { id: 22, x: 5, y: 2, marked: false, piece: { id: 13, king: false, playerNumber: 2, selected: false} },
    { id: 23, x: 3, y: 2, marked: false, piece: { id: 14, king: false, playerNumber: 2, selected: false} },
    { id: 24, x: 1, y: 2, marked: false, piece: { id: 15, king: false, playerNumber: 2, selected: false} },
