...
let gameState = {
  ...
  squares: [
    { id: 1, x: 6, y: 7, marked: false, piece: null },

    { id: 2, x: 4, y: 7, marked: false, piece: null },
    { id: 3, x: 2, y: 7, marked: false, piece: null },
    { id: 4, x: 0, y: 7, marked: false, piece: null },

    { id: 5, x: 7, y: 6, marked: false, piece: null },
    ...
    { id: 28, x: 0, y: 1, marked: false, piece: { id: 3, king: false, playerNumber: 1, selected: false} },
