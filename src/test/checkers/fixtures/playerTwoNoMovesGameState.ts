...
let gameState = {
  ...
  squares: [
    ...
    { id: 5, x: 7, y: 6, marked: false, piece: { id: 20, king: false, playerNumber: 2, selected: false} },
    { id: 6, x: 5, y: 6, marked: false, piece: null },
    { id: 7, x: 3, y: 6, marked: false, piece: null },
    { id: 8, x: 1, y: 6, marked: false, piece: null },

    { id: 9, x: 6, y: 5, marked: false, piece: null },
    { id: 10, x: 4, y: 5, marked: false, piece: null },
    ...
    { id: 25, x: 6, y: 1, marked: false, piece: null },
    { id: 26, x: 4, y: 1, marked: false, piece: null },
    { id: 27, x: 2, y: 1, marked: false, piece: null },
    { id: 28, x: 0, y: 1, marked: false, piece: null },

    { id: 29, x: 7, y: 0, marked: false, piece: null },
    { id: 30, x: 5, y: 0, marked: false, piece: null },
    { id: 31, x: 3, y: 0, marked: false, piece: null },
    { id: 32, x: 1, y: 0, marked: false, piece: null }
  ]
};
