...
let match = {
  ...
  gameState: {
    ...
    squares: [
      ...
      { id: 'e4', x: 4, y: 4, piece: { id: 21, playerNumber: 1, type: 'pawn', hasMoved: false, selected: false } },
      ...
      { id: 'h2', x: 7, y: 6, piece: { id: 24, playerNumber: 1, type: 'pawn', hasMoved: false, selected: false } },
  ...
  currentMove: null,
  promotion: false,
  lastAction: { kind: 'move', data: { fromId: 'e2', toId: 'e4', pieceType: null } },
