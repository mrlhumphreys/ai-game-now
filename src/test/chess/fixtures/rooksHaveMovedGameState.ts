...
let gameState = {
  ...
  squares: [
    ...
    { id: 'a1', x: 0, y: 7, piece: { id: 25, player_number: 1, type: 'rook', has_moved: true, selected: false } },
    ...
    { id: 'h1', x: 7, y: 7, piece: { id: 32, player_number: 1, type: 'rook', has_moved: true, selected: false } }
  ]
};
