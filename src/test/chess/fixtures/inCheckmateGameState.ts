...
let gameState = {
  ...
  squares: [
    ...
    { id: 'a2', x: 0, y: 6, piece: { id: 1, playerNumber: 2, type: 'rook', selected: false } },
    ...
    { id: 'a1', x: 0, y: 7, piece: { id: 32, playerNumber: 1, type: 'rook', selected: false } },
    ...
    { id: 'h1', x: 7, y: 7, piece: { id: 8, playerNumber: 2, type: 'rook', selected: false } }
  ],
  castleMoves: [
