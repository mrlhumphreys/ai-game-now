...
let gameState = {
  ...
  squares: [
    ...
    { id: 'a2', x: 0, y: 6, piece: { id: 1, player_number: 2, type: 'rook', has_moved: false, selected: false } },
    ...
    { id: 'h1', x: 7, y: 7, piece: { id: 8, player_number: 2, type: 'rook', has_moved: false, selected: false } }
  ]
};
