...
let gameState = {
  ...
  squares: [
    ...
    { id: 'd3', x: 3, y: 5, piece: { id: 4, playerNumber: 2, type: 'queen', hasMoved: false, selected: false } },
    { id: 'e3', x: 4, y: 5, piece: null },
    { id: 'f3', x: 5, y: 5, piece: { id: 7, playerNumber: 2, type: 'knight', hasMoved: false, selected: false } },
    { id: 'g3', x: 6, y: 5, piece: null },
    { id: 'h3', x: 7, y: 5, piece: { id: 32, playerNumber: 1, type: 'rook', hasMoved: false, selected: false } },
    ...
    { id: 'h2', x: 7, y: 6, piece: { id: 8, playerNumber: 2, type: 'rook', hasMoved: false, selected: false } },
