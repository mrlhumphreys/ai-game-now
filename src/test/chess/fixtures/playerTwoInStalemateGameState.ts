...
let gameState = {
  ...
  squares: [
    { id: 'a8', x: 0, y: 0, piece: { id: 5, playerNumber: 2, type: 'king', selected: false } },
    ...
    { id: 'c7', x: 2, y: 1, piece: { id: 28, playerNumber: 1, type: 'queen', selected: false } },
    ...
    { id: 'a1', x: 0, y: 7, piece: { id: 29, playerNumber: 1, type: 'king', selected: false } },
