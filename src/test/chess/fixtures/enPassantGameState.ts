...
let gameState = {
  ...
  squares: [
    ...
    { id: 'c5', x: 2, y: 3, piece: { id: 32, player_number: 1, type: 'rook', has_moved: false, selected: false } },
    { id: 'd5', x: 3, y: 3, piece: { id: 12, player_number: 2, type: 'pawn', has_moved: false, selected: false } },
    { id: 'e5', x: 4, y: 3, piece: { id: 21, player_number: 1, type: 'pawn', has_moved: false, selected: false } },
    { id: 'f5', x: 5, y: 3, piece: null },
    { id: 'g5', x: 6, y: 3, piece: null },
    { id: 'h5', x: 7, y: 3, piece: { id: 24, player_number: 1, type: 'pawn', has_moved: false, selected: false } },
