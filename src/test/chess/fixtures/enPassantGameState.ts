...
let gameState = {
  ...
  lastDoubleStepPawnId: 12,
  squares: [
    { id: 'a8', x: 0, y: 0, piece: { id: 1, playerNumber: 2, type: 'rook', hasMoved: false, selected: false } },
    { id: 'b8', x: 1, y: 0, piece: { id: 2, playerNumber: 2, type: 'knight', hasMoved: false, selected: false } },
    { id: 'c8', x: 2, y: 0, piece: { id: 3, playerNumber: 2, type: 'bishop', hasMoved: false, selected: false } },
    { id: 'd8', x: 3, y: 0, piece: { id: 4, playerNumber: 2, type: 'queen', hasMoved: false, selected: false } },
    { id: 'e8', x: 4, y: 0, piece: { id: 5, playerNumber: 2, type: 'king', hasMoved: false, selected: false } },
    { id: 'f8', x: 5, y: 0, piece: { id: 6, playerNumber: 2, type: 'bishop', hasMoved: false, selected: false } },
    { id: 'g8', x: 6, y: 0, piece: { id: 7, playerNumber: 2, type: 'knight', hasMoved: false, selected: false } },
    ...
    { id: 'c5', x: 2, y: 3, piece: { id: 32, playerNumber: 1, type: 'rook', hasMoved: false, selected: false } },
    { id: 'd5', x: 3, y: 3, piece: { id: 12, playerNumber: 2, type: 'pawn', hasMoved: false, selected: false } },
    { id: 'e5', x: 4, y: 3, piece: { id: 21, playerNumber: 1, type: 'pawn', hasMoved: false, selected: false } },
    { id: 'f5', x: 5, y: 3, piece: null },
    { id: 'g5', x: 6, y: 3, piece: null },
    { id: 'h5', x: 7, y: 3, piece: { id: 24, playerNumber: 1, type: 'pawn', hasMoved: false, selected: false } },
    ...
    { id: 'a1', x: 0, y: 7, piece: { id: 25, playerNumber: 1, type: 'rook', hasMoved: false, selected: false } },
    { id: 'b1', x: 1, y: 7, piece: { id: 26, playerNumber: 1, type: 'knight', hasMoved: false, selected: false } },
    { id: 'c1', x: 2, y: 7, piece: { id: 27, playerNumber: 1, type: 'bishop', hasMoved: false, selected: false } },
    { id: 'd1', x: 3, y: 7, piece: { id: 28, playerNumber: 1, type: 'queen', hasMoved: false, selected: false } },
