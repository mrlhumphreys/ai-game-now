  ...
  it('should return default game state', () => {
    ...
    let expected = {
      ...
      squares: [
        ...
        { id: 'c8', x: 2, y: 0, piece: { id: 2, playerNumber: 2, type: 'bishop', selected: false } },
        { id: 'd8', x: 3, y: 0, piece: { id: 3, playerNumber: 2, type: 'queen', selected: false } },
        { id: 'e8', x: 4, y: 0, piece: { id: 4, playerNumber: 2, type: 'king', selected: false } },
        { id: 'f8', x: 5, y: 0, piece: { id: 5, playerNumber: 2, type: 'bishop', selected: false } },
        { id: 'g8', x: 6, y: 0, piece: { id: 6, playerNumber: 2, type: 'knight', selected: false } },
        { id: 'h8', x: 7, y: 0, piece: { id: 7, playerNumber: 2, type: 'rook', selected: false } },
