...
describe('absDx', () => {
  it('must return the absolute difference on the x axis', () => {
    let a = { x: 3, y: 0 };
    let b = { x: 1, y: 0 };
    expect(absDx(a, b)).toEqual(2);
  });
});

describe('absDy', () => {
  it('must return the absolute difference on the y axis', () => {
    let a = { x: 0, y: 3 };
    let b = { x: 0, y: 1 };
    expect(absDy(a, b)).toEqual(2);
  });
});
