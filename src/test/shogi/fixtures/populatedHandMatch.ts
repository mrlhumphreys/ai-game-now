...
let match = {
  ...
  gameState: {
    ...
    hands: [
      { playerNumber: 1,
        pieces: [
          { id: 31, playerNumber: 1, type: 'hisha' as const, selected: false },
          { id: 29, playerNumber: 1, type: 'fuhyou' as const, selected: false },
          { id: 28, playerNumber: 1, type: 'fuhyou' as const, selected: false },
          { id: 27, playerNumber: 1, type: 'fuhyou' as const, selected: false },
          { id: 26, playerNumber: 1, type: 'fuhyou' as const, selected: false },
          { id: 35, playerNumber: 1, type: 'kinshou' as const, selected: false }
        ]
      },
      { playerNumber: 2,
        pieces: [
          { id: 3, playerNumber: 2, type: 'ginshou' as const, selected: false },
          { id: 7, playerNumber: 2, type: 'ginshou' as const, selected: false },
          { id: 11, playerNumber: 2, type: 'kakugyou' as const, selected: false },
          { id: 18, playerNumber: 2, type: 'fuhyou' as const, selected: false },
          { id: 19, playerNumber: 2, type: 'fuhyou' as const, selected: false },
          { id: 20, playerNumber: 2, type: 'fuhyou' as const, selected: false },
          { id: 30, playerNumber: 2, type: 'kakugyou' as const, selected: false }
        ]
      }
    ]
  },
