...
let gameState = {
  ...
  squares: [
    ...
    { id: '68', x: 3, y: 7, piece: { id: 35, playerNumber: 1, type: 'kinshou' as const, selected: false } },
    { id: '58', x: 4, y: 7, piece: { id: 6, playerNumber: 2, type: 'kinshou' as const, selected: false } },
