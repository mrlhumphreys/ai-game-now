...
let gameState = {
  ...
  squares: [
    ...
    { id: '12', x: 8, y: 1, piece: { id: 10, playerNumber: 2, type: 'hisha' as const, selected: false } },
    ...
    { id: '13', x: 8, y: 2, piece: { id: 31, playerNumber: 1, type: 'hisha' as const, selected: false } },
