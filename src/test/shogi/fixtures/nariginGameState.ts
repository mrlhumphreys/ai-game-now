...
let gameState = {
  ...
  squares: [
    ...
    { id: '55', x: 4, y: 4, piece: { id: 38, playerNumber: 1, type: 'ginshou' as const, selected: false } },
    ...
    { id: '88', x: 1, y: 7, piece: { id: 30, playerNumber: 1, type: 'kakugyou' as const, selected: false } },
    ...
    { id: '29', x: 7, y: 8, piece: { id: 39, playerNumber: 1, type: 'narikei' as const, selected: false } },
