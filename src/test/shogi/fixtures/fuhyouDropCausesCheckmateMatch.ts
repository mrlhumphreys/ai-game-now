...
let match = {
  ...
  gameState: {
    ...
    squares: [
      ...
      { id: '72', x: 2, y: 1, piece: { id: 35, playerNumber: 1, type: 'kinshou' as const, selected: false } },
      { id: '62', x: 3, y: 1, piece: null },
      { id: '52', x: 4, y: 1, piece: null },
      { id: '42', x: 5, y: 1, piece: null },
      { id: '32', x: 6, y: 1, piece: { id: 37, playerNumber: 1, type: 'kinshou' as const, selected: false } },
      ...
      { id: '53', x: 4, y: 2, piece: { id: 38, playerNumber: 1, type: 'ginshou' as const, selected: false } },
    ...
    hands: [
      { playerNumber: 1, pieces: [
        { id: 17, playerNumber: 1, type: 'fuhyou' as const, selected: true }
      ] },
