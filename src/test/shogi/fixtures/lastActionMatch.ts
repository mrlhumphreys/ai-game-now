...
let match = {
  ...
  gameState: {
    ...
    squares: [
      ...
      { id: '71', x: 2, y: 0, piece: { id: 3, playerNumber: 2, type: 'ginshou', selected: false } },
      ...
      { id: '31', x: 6, y: 0, piece: { id: 7, playerNumber: 2, type: 'ginshou', selected: false } },
      { id: '21', x: 7, y: 0, piece: { id: 8, playerNumber: 2, type: 'keima', selected: false } },
      ...
      { id: '63', x: 3, y: 2, piece: { id: 15, playerNumber: 2, type: 'fuhyou', selected: false } },
      { id: '53', x: 4, y: 2, piece: { id: 16, playerNumber: 2, type: 'fuhyou', selected: false } },
      { id: '43', x: 5, y: 2, piece: { id: 17, playerNumber: 2, type: 'fuhyou', selected: false } },
      { id: '33', x: 6, y: 2, piece: { id: 18, playerNumber: 2, type: 'fuhyou', selected: false } },
      { id: '23', x: 7, y: 2, piece: { id: 19, playerNumber: 2, type: 'fuhyou', selected: false } },
      ...
      { id: '56', x: 4, y: 5, piece: { id: 25, playerNumber: 1, type: 'fuhyou', selected: false } },
      ...
      { id: '87', x: 1, y: 6, piece: { id: 22, playerNumber: 1, type: 'fuhyou', selected: false } },
      { id: '77', x: 2, y: 6, piece: { id: 23, playerNumber: 1, type: 'fuhyou', selected: false } },
      { id: '67', x: 3, y: 6, piece: { id: 24, playerNumber: 1, type: 'fuhyou', selected: false } },
      { id: '57', x: 4, y: 6, piece: null },
      { id: '47', x: 5, y: 6, piece: { id: 26, playerNumber: 1, type: 'fuhyou', selected: false } },
      { id: '37', x: 6, y: 6, piece: { id: 27, playerNumber: 1, type: 'fuhyou', selected: false } },
      { id: '27', x: 7, y: 6, piece: { id: 28, playerNumber: 1, type: 'fuhyou', selected: false } },
      { id: '17', x: 8, y: 6, piece: { id: 29, playerNumber: 1, type: 'fuhyou', selected: false } },

      { id: '98', x: 0, y: 7, piece: null },
      { id: '88', x: 1, y: 7, piece: { id: 30, playerNumber: 1, type: 'kakugyou', selected: false } },
      { id: '78', x: 2, y: 7, piece: null },
      { id: '68', x: 3, y: 7, piece: null },
      { id: '58', x: 4, y: 7, piece: null },
      { id: '48', x: 5, y: 7, piece: null },
      { id: '38', x: 6, y: 7, piece: null },
      { id: '28', x: 7, y: 7, piece: { id: 31, playerNumber: 1, type: 'hisha', selected: false } },
      { id: '18', x: 8, y: 7, piece: null },

      { id: '99', x: 0, y: 8, piece: { id: 32, playerNumber: 1, type: 'kyousha', selected: false } },
      { id: '89', x: 1, y: 8, piece: { id: 33, playerNumber: 1, type: 'keima', selected: false } },
      { id: '79', x: 2, y: 8, piece: { id: 34, playerNumber: 1, type: 'ginshou', selected: false } },
      { id: '69', x: 3, y: 8, piece: { id: 35, playerNumber: 1, type: 'kinshou', selected: false } },
      { id: '59', x: 4, y: 8, piece: { id: 36, playerNumber: 1, type: 'oushou', selected: false } },
      { id: '49', x: 5, y: 8, piece: { id: 37, playerNumber: 1, type: 'kinshou', selected: false } },
      { id: '39', x: 6, y: 8, piece: { id: 38, playerNumber: 1, type: 'ginshou', selected: false } },
      { id: '29', x: 7, y: 8, piece: { id: 39, playerNumber: 1, type: 'keima', selected: false } },
      { id: '19', x: 8, y: 8, piece: { id: 40, playerNumber: 1, type: 'kyousha', selected: false } }
    ],
    hands: [
  ...
  currentMove: null,
  promotion: false,
  lastAction: { kind: 'move', data: { fromId: '56', pieceId: null, toId: '57', promote: false } },
