...
let match = {
  ...
  gameState: {
    ...
    squares: [
      ...
      { id: '11', x: 8, y: 0, piece: { id: 31, playerNumber: 1, type: 'hisha' as const, selected: false } },
      ...
      { id: '53', x: 4, y: 2, piece: { id: 35, playerNumber: 1, type: 'kinshou' as const, selected: false } },
  ...
  winner: null,
  currentMove: { kind: 'move', fromId: '12', toId: '11', promote: false },
  promotion: true,
  lastAction: null,
