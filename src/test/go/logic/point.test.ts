...
describe('occupied', () => {
  it('returns true if point has stone', () => {
    let point = { id: 1, x: 1, y: 1, stone: { id: 1, playerNumber: 1, chainId: 1 }, territoryId: null };
    let result = occupied(point);
    expect(result).toBe(true);
  });

  it('returns false if point has no stone', () => {
    let point = { id: 1, x: 1, y: 1, stone: null, territoryId: null };
    let result = occupied(point);
...
describe('occupiedByOpponent', () => {
  it('returns true if occupied by the opponent', () => {
    let point = { id: 1, x: 1, y: 1, stone: { id: 1, playerNumber: 2, chainId: 1 }, territoryId: null };
...
describe('unmarked', () => {
  ...
  it('returns true if territoryId is not null', () => {
    let point = { id: 1, x: 1, y: 1, stone: null, territoryId: 5 };
    let result = unmarked(point);
    expect(result).toBe(false);
  });
});
...
describe('captureStone', () => {
  it('removes the stone from the point', () => {
    let point = { id: 1, x: 1, y: 1, stone: { id: 1, playerNumber: 1, chainId: 1 }, territoryId: 5 };
    captureStone(point);
...
describe('clearTerritory', () => {
  it('returns', () => {
    let point = { id: 1, x: 1, y: 1, stone: null, territoryId: 4 };
