...
let gameState = {
  ...
  points: [
    ...
    { id: 36, x: 16, y: 1, stone: { id: 4, playerNumber: 2, chainId: 4 }, territoryId: null },
    ...
    { id: 54, x: 15, y: 2, stone: { id: 2, playerNumber: 2, chainId: 2 }, territoryId: null },
    { id: 55, x: 16, y: 2, stone: { id: 1, playerNumber: 1, chainId: 1 }, territoryId: null },
    { id: 56, x: 17, y: 2, stone: { id: 3, playerNumber: 2, chainId: 3 }, territoryId: null },
