...
let match = {
  ...
  gameState: {
    ...
    points: [
      ...
      { id: 20, x: 0, y: 1, stone: { id: 2, playerNumber: 1, chainId: 2 }, territoryId: null },
      { id: 21, x: 1, y: 1, stone: null, territoryId: null },
      { id: 22, x: 2, y: 1, stone: { id: 3, playerNumber: 1, chainId: 3 }, territoryId: null },
      ...
      { id: 39, x: 0, y: 2, stone: { id: 5, playerNumber: 2, chainId: 5 }, territoryId: null },
      { id: 40, x: 1, y: 2, stone: { id: 4, playerNumber: 1, chainId: 4 }, territoryId: null },
      { id: 41, x: 2, y: 2, stone: { id: 6, playerNumber: 2, chainId: 6 }, territoryId: null },
      ...
      { id: 59, x: 1, y: 3, stone: { id: 7, playerNumber: 2, chainId: 7 }, territoryId: null },
