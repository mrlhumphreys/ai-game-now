...
let match = {
  ...
  gameState: {
    ...
    points: [
      { id: 'aa', x: 0, y: 0, stone: { id: 10, playerNumber: 2, chainId: 6 }, territoryId: null },
      { id: 'ba', x: 1, y: 0, stone: { id: 3, playerNumber: 1, chainId: 3 }, territoryId: null },
      ...
      { id: 'ab', x: 0, y: 1, stone: { id: 12, playerNumber: 2, chainId: 6 }, territoryId: null },
      { id: 'bb', x: 1, y: 1, stone: { id: 5, playerNumber: 1, chainId: 3 }, territoryId: null },
      { id: 'cb', x: 2, y: 1, stone: null, territoryId: null },
      ...
      { id: 'bc', x: 1, y: 2, stone: { id: 9, playerNumber: 1, chainId: 3 }, territoryId: null },
      ...
      { id: 'ad', x: 0, y: 3, stone: { id: 7, playerNumber: 1, chainId: 4 }, territoryId: null },
      ...
      { id: 'be', x: 1, y: 4, stone: { id: 15, playerNumber: 1, chainId: 10 }, territoryId: null },
      ...
      { id: 'qe', x: 16, y: 4, stone: { id: 11, playerNumber: 1, chainId: 7 }, territoryId: null },
      { id: 're', x: 17, y: 4, stone: null, territoryId: null },
      { id: 'se', x: 18, y: 4, stone: null, territoryId: null },

      { id: 'af', x: 0, y: 5, stone: { id: 13, playerNumber: 1, chainId: 8 }, territoryId: null },
      ...
      { id: 'ag', x: 0, y: 6, stone: { id: 14, playerNumber: 2, chainId: 9 }, territoryId: null },
      ...
      { id: 'ah', x: 0, y: 7, stone: { id: 16, playerNumber: 2, chainId: 9 }, territoryId: null },
    ...
    playerStats: [
      { playerNumber: 1, prisonerCount: 4, passed: false },
      { playerNumber: 2, prisonerCount: 0, passed: false }
    ],
    previousState: "21-----------------21------------------1-----------------1--------------1----1--------------1--1------------------2------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------"
  },
  players: [
  ...
  lastAction: null,
  notification: "Point has no liberties."
};
