...
let match = {
  ...
  gameState: {
    ...
    points: [
     { id: 'aa', x: 0, y: 0, stone: { id: 2, playerNumber: 2, chainId: 2 }, territoryId: null },
     { id: 'ba', x: 1, y: 0, stone: { id: 4, playerNumber: 2, chainId: 2 }, territoryId: null },
     { id: 'ca', x: 2, y: 0, stone: { id: 6, playerNumber: 2, chainId: 2 }, territoryId: null },
     { id: 'da', x: 3, y: 0, stone: { id: 13, playerNumber: 1, chainId: 11 }, territoryId: null },
     { id: 'ea', x: 4, y: 0, stone: null, territoryId: null },
     { id: 'fa', x: 5, y: 0, stone: { id: 11, playerNumber: 1, chainId: 9 }, territoryId: null },
     { id: 'ga', x: 6, y: 0, stone: { id: 12, playerNumber: 2, chainId: 10 }, territoryId: null },
     { id: 'ha', x: 7, y: 0, stone: { id: 14, playerNumber: 2, chainId: 10 }, territoryId: null },
     { id: 'ia', x: 8, y: 0, stone: { id: 16, playerNumber: 2, chainId: 10 }, territoryId: null },
     { id: 'ja', x: 9, y: 0, stone: { id: 23, playerNumber: 1, chainId: 18 }, territoryId: null },
     { id: 'ka', x: 10, y: 0, stone: { id: 18, playerNumber: 2, chainId: 14 }, territoryId: null },
     { id: 'la', x: 11, y: 0, stone: { id: 22, playerNumber: 2, chainId: 14 }, territoryId: null },
     ...
     { id: 'cb', x: 2, y: 1, stone: { id: 5, playerNumber: 1, chainId: 4 }, territoryId: null },
     { id: 'db', x: 3, y: 1, stone: null, territoryId: null },
     { id: 'eb', x: 4, y: 1, stone: { id: 7, playerNumber: 1, chainId: 5 }, territoryId: null },
     ...
     { id: 'ib', x: 8, y: 1, stone: { id: 17, playerNumber: 1, chainId: 13 }, territoryId: null },
     { id: 'jb', x: 9, y: 1, stone: null, territoryId: null },
     { id: 'kb', x: 10, y: 1, stone: { id: 19, playerNumber: 1, chainId: 15 }, territoryId: null },
     ...
     { id: 'dc', x: 3, y: 2, stone: { id: 9, playerNumber: 1, chainId: 7 }, territoryId: null },
     ...
     { id: 'jc', x: 9, y: 2, stone: { id: 21, playerNumber: 1, chainId: 17 }, territoryId: null },
     ...
     { id: 'pd', x: 15, y: 3, stone: { id: 1, playerNumber: 1, chainId: 1 }, territoryId: null },
    ...
    playerStats: [
        { playerNumber: 1, prisonerCount: 3, passed: false },
        { playerNumber: 2, prisonerCount: 2, passed: false }
    ],
    previousState: "2221-1222-22---------1-1---121-----------1-----1------------------------1------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------"
  },
  players: [
  ...
  lastAction: null,
  notification: "Move would return board to previous state."
};
