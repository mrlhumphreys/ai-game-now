...
let match = {
  ...
  gameState: {
    ...
    points: [
      ...
      { id: 3, x: 2, y: 0, stone: { id: 2, playerNumber: 2, chainId: 2 }, territoryId: null },
      { id: 4, x: 3, y: 0, stone: { id: 1, playerNumber: 1, chainId: 1 }, territoryId: null },
      { id: 5, x: 4, y: 0, stone: { id: 4, playerNumber: 2, chainId: 4 }, territoryId: null },
