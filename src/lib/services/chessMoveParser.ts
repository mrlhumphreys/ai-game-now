    ...
    if (exists(components.movingPiece)) {
        ...
        let from = state.squares.find(function(s) {
          ...
          switch(movingPiece) {
            case 'R':
              ...
              pieceBelongsToPlayer = s.piece !== null && s.piece.type === 'rook' && s.piece.player_number === state.current_player_number;
            ...
            case 'N':
              ...
              pieceBelongsToPlayer = s.piece !== null && s.piece.type === 'knight' && s.piece.player_number === state.current_player_number;
            ...
            case 'B':
              ...
              pieceBelongsToPlayer = s.piece !== null && s.piece.type === 'bishop' && s.piece.player_number === state.current_player_number;
            ...
            case 'Q':
              ...
              pieceBelongsToPlayer = s.piece !== null && s.piece.type === 'queen' && s.piece.player_number === state.current_player_number;
            ...
            case 'K':
              // only king
              pieceBelongsToPlayer = s.piece !== null && s.piece.type === 'king' && s.piece.player_number === state.current_player_number;
      ...
      if (components.fromRank !== undefined && hasKey(RANK_TO_Y, components.fromRank)) {
        ...
        let square = state.squares.find(function(s) {
          ...
          return s.piece !== null && s.piece.type === 'pawn' && s.piece.player_number === state.current_player_number && s.x === fromX; 
        });
